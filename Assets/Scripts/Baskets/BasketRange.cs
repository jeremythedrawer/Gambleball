...
public class BasketRange : LevelObjectRange
{
    ...
    private void Start()
    {
        ...
        Vector2 topRight = Camera.main.ViewportToWorldPoint(new Vector2(resetPosWidth, resetPosHeight));
    ...
    {
        Vector2 viewportbottomRight = Camera.main.ViewportToWorldPoint(Vector2.right);
        ...
        Vector2 topRight = Camera.main.ViewportToWorldPoint(new Vector2(resetPosWidth, resetPosHeight));
        Vector2 topLeft = Camera.main.ViewportToWorldPoint(new Vector2(1, resetPosHeight)) - new Vector3(distanceFromRight, 0);
        Vector2 bottomRight = Camera.main.ViewportToWorldPoint(new Vector2(resetPosWidth, 0)) + new Vector3(0, distanceFromBottom);
